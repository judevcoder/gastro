...
(function () {
    ...
    function ClientDashboardController($rootScope,$scope,$timeout,ClientService, $state, $translate, $interval, $filter, $geolocation) {
        ...
        function sendEmail(selected){
            ...
            var content = "id: " + vm.quiz.ID + "\n" +
                          "question: " + vm.quiz.CZE_question + "\n" +
                          "answer_a: " + vm.quiz.CZE_a + "\n" +
                          "answer_b: " + vm.quiz.CZE_b + "\n" +
                          "answer_c: " + vm.quiz.CZE_c + "\n" +
                          "answer_d: " + vm.quiz.CZE_d + "\n" +
                          "note: " + vm.quiz.q_note + "\n" +
